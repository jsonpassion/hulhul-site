...
| `assets/brand/` | 나비 로고(96px), 파비콘(64px), 홈 화면 아이콘(180px) |
...
- **마크**: 하늘빛 타일 위의 수채 고양이가 발로 사진을 밀어내는 그림(2026-09 앱 아이콘과 같은 그림). 나비 로고, 파비콘, 홈 화면 아이콘은 `assets/brand/`에 있고 앱의 로고 타일에서 뽑았습니다.
